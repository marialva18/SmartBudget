...
export function HomeSecuritySection() {
  return (
    <section
      id="confianza"
      className="qori-public-light-section bg-[#edf7f3] px-5 py-16"
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {trustItems.map((item, index) => {
            ...
            return (
              <article
                className={`qori-card-motion qori-card-delay-${index} qori-public-card rounded-2xl border border-white/80 bg-white/72 p-6 shadow-[0_18px_45px_rgba(13,148,136,0.08)] transition hover:-translate-y-1 hover:border-[#9bd8cf] hover:shadow-[0_22px_55px_rgba(13,148,136,0.16)]`}
                key={item.title}
              >
