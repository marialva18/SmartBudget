    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f7f9fb] px-5 py-10">
      <AuthCard className="w-full max-w-[480px]">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-xl border border-[#bacac5]/40 bg-[#f2f4f6] text-[#006b5f]">
            <LockKeyhole size={40} />
          </div>
          <p className="mb-3 font-mono text-xs font-semibold uppercase tracking-[0.18em] text-[#006b5f]">
            Credencial protegida
          </p>
          <h1 className="text-3xl font-extrabold">Crea una nueva contraseña</h1>
        ...
        <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-[#006b5f] font-semibold text-white shadow-[0_10px_30px_rgba(13,148,136,0.18)] transition hover:bg-[#005047] disabled:opacity-70"
